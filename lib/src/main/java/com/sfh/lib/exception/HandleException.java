...
public final class HandleException extends RuntimeException {
    ...
    public static HandleException handleException(Throwable e) {
        ...
        if (e == null) {
            return new HandleException(CODE_NULL, MVCache.getApplication().getString(R.string.exception_null));
        }
        ...
        if (crashReportHandler != null && (exception = MVCache.getInstance().getCrashReport().accept(e)) != null) {
            //上层处理异常
            return exception;
        }
        ...
        if (e instanceof HttpCodeException || throwable instanceof HttpCodeException){
            return new HandleException(CODE_HTTP, MVCache.getApplication().getString(R.string.exception_http), e);
        }
        ...
        if (e instanceof ConnectTimeoutException
            ...
            return new HandleException(CODE_TIMEOUT, MVCache.getApplication().getString(R.string.exception_timeout), e);
        }
        ...
        if (e instanceof ConnectException
            ...
            return new HandleException(CODE_NET, MVCache.getApplication().getString(R.string.exception_net), e);
        }
        ...
        if (e instanceof JSONException
            ...
            return new HandleException(CODE_PARSE, MVCache.getApplication().getString(R.string.exception_parse), e);
        }
        //没有信任证书，导致请求失败
        if (e instanceof SSLException || throwable instanceof SSLException ) {
            return new HandleException(CODE_SSL, MVCache.getApplication().getString(R.string.exception_ssl), e);
        }
        // IO读写时出现
        if (e instanceof IOException || throwable instanceof IOException) {
            return new HandleException(CODE_IO, MVCache.getApplication().getString(R.string.exception_io), e);
        }
        // 未捕获异常情况
        return new HandleException(CODE_UNKNOWN, MVCache.getApplication().getString(R.string.exception_unknown), e);
    }
